      ...
      <List>
        ...
        */}
        ...
        <ListItemButton onClick={() => navigate("/justification/list")}>
          ...
          <ListItemText primary="Justificacion de atrasos" />
        </ListItemButton>
        ...
        <ListItemButton onClick={() => navigate("/autorization/list")}>
          ...
          <ListItemText primary="Autorizacion de horas extra" />
        </ListItemButton>
        ...
        <ListItemButton onClick={() => navigate("/inandoutreg")}>
          ...
          <ListItemText primary="Registrar entradas y salidas" />
        </ListItemButton>
          {/*
        ...
        <ListItemButton onClick={() => navigate("/latearrivals/calculate")}>
          <ListItemIcon>
            <MoreTimeIcon />
          </ListItemIcon>
          <ListItemText primary="Calculo de atrasos" />
        </ListItemButton>
            */}
        ...
        <ListItemButton onClick={() => navigate("/paycheck/list")}>
          ...
          <ListItemText primary="Calcular planilla Sueldos" />
        </ListItemButton>
            {/*
